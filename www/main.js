...
var $evancz$elm_playground$Playground$Animation = F3(
	function (a, b, c) {
...
var $evancz$elm_playground$Playground$animationSubscriptions = $elm$core$Platform$Sub$batch(
	_List_fromArray(
		[
...
var $evancz$elm_playground$Playground$animationUpdate = F2(
	function (msg, state) {
		var v = state.a;
		var s = state.b;
		var t = state.c;
		switch (msg.$) {
			case 'Tick':
				var posix = msg.a;
				return A3(
					$evancz$elm_playground$Playground$Animation,
					v,
					s,
					$evancz$elm_playground$Playground$Time(posix));
			case 'VisibilityChanged':
				var vis = msg.a;
				return A3($evancz$elm_playground$Playground$Animation, vis, s, t);
			case 'GotViewport':
				var viewport = msg.a.viewport;
				return A3(
					$evancz$elm_playground$Playground$Animation,
					v,
					A2($evancz$elm_playground$Playground$toScreen, viewport.width, viewport.height),
					t);
			case 'Resized':
				var w = msg.a;
				var h = msg.b;
				return A3(
					$evancz$elm_playground$Playground$Animation,
					v,
					A2($evancz$elm_playground$Playground$toScreen, w, h),
					t);
			case 'KeyChanged':
				return state;
			case 'MouseMove':
...
var $evancz$elm_playground$Playground$animation = function (viewFrame) {
	...
	var update = F2(
		function (msg, model) {
			return _Utils_Tuple2(
				A2($evancz$elm_playground$Playground$animationUpdate, msg, model),
				$elm$core$Platform$Cmd$none);
		});
	var subscriptions = function (_v2) {
		...
		if (visibility.$ === 'Hidden') {
			...
			return $evancz$elm_playground$Playground$animationSubscriptions;
		}
	};
	var init = function (_v0) {
		return _Utils_Tuple2(
			A3(
				...
				$evancz$elm_playground$Playground$Time(
...
var $evancz$elm_playground$Playground$Ngon = F3(
	function (a, b, c) {
		return {$: 'Ngon', a: a, b: b, c: c};
	});
var $evancz$elm_playground$Playground$triangle = F2(
	function (color, radius) {
		return A6(
			...
			1,
			1,
			A3($evancz$elm_playground$Playground$Ngon, color, 3, radius));
	});
var $author$project$Main$view = function (time) {
	return _List_fromArray(
		[
			...
			A2($evancz$elm_playground$Playground$spin, 12, time),
			A2($evancz$elm_playground$Playground$triangle, $evancz$elm_playground$Playground$blue, 100))
		]);
};
var $author$project$Main$main = $evancz$elm_playground$Playground$animation($author$project$Main$view);
_Platform_export({'Main':{'init':$author$project$Main$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.1"},"types":{"message":"Playground.Msg","aliases":{"Browser.Dom.Viewport":{"args":[],"type":"{ scene : { width : Basics.Float, height : Basics.Float }, viewport : { x : Basics.Float, y : Basics.Float, width : Basics.Float, height : Basics.Float } }"}},"unions":{"Playground.Msg":{"args":[],"tags":{"KeyChanged":["Basics.Bool","String.String"],"Tick":["Time.Posix"],"GotViewport":["Browser.Dom.Viewport"],"Resized":["Basics.Int","Basics.Int"],"VisibilityChanged":["Browser.Events.Visibility"],"MouseMove":["Basics.Float","Basics.Float"],"MouseClick":[],"MouseButton":["Basics.Bool"]}},"Basics.Bool":{"args":[],"tags":{"True":[],"False":[]}},"Basics.Float":{"args":[],"tags":{"Float":[]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"Time.Posix":{"args":[],"tags":{"Posix":["Basics.Int"]}},"String.String":{"args":[],"tags":{"String":[]}},"Browser.Events.Visibility":{"args":[],"tags":{"Visible":[],"Hidden":[]}}}}})}});}(this));